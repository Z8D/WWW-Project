...
// function to check if a user has the isadmin entry in their row
// returns true if the user is an admin and false otherwise
  ...
  // returns true if user has light theme selected or a 1 in the settings entry in the tickets table
  ...
  // function used to set the user theme in the DB
  // if it is set to true, then they have selected light theme
  // else dark theme
